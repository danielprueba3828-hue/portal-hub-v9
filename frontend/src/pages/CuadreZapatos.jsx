...
export default function CuadreZapatos() {
  ...
  // Escuchar cambios de fecha y tienda para consultar historial
  useEffect(() => {
    if (fechaCierre && tiendaSeleccionada?.id) {
      // Limpiar archivos locales y cálculos temporales para evitar mezclar datos
      setPisoFile(null);
      setPisoData([]);
      setTipeoFile(null);
      setTipeoData([]);
      ...
      fetchSavedClosure(fechaCierre);
    }
  }, [fechaCierre, tiendaSeleccionada]);
  ...
  return (
    <div className={`min-h-screen p-6 transition-colors duration-300 ${tc.mainBg}`} style={tc.mainBgStyle}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className={`text-3xl font-title font-black tracking-wider flex items-center gap-3 ${tc.textPrimary}`}>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex bg-slate-950/60 p-1 border border-slate-800/80 rounded-2xl">
            <button
              className="flex items-center gap-2 px-4 py-2 rounded-xl font-bold text-xs transition-all cursor-pointer bg-emerald-500 text-white shadow-md"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl font-bold text-xs transition-all cursor-pointer text-slate-400 hover:text-white"
            >
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div
                ...
                className={`p-6 flex flex-col justify-between items-center text-center border-2 border-dashed rounded-3xl min-h-[260px] transition-all relative ${
                  pisoFile
              ...
              >
                ...
                {pisoFile ? (
                  <div className="w-full flex items-center justify-between px-3 py-2 bg-emerald-950/20 border border-emerald-500/20 rounded-2xl text-xs text-emerald-400 mt-4">
                    ...
                    <button onClick={() => removeFile('piso')} className="text-slate-400 hover:text-white cursor-pointer ml-2">
                      <X className="w-4 h-4" />
                    </button>
                  </div>
                ) : (
              ...
              >
                ...
                {tipeoFile ? (
                  <div className="w-full flex items-center justify-between px-3 py-2 bg-emerald-950/20 border border-emerald-500/20 rounded-2xl text-xs text-emerald-400 mt-4">
                    ...
                    <button onClick={() => removeFile('tipeo')} className="text-slate-400 hover:text-white cursor-pointer ml-2">
                      <X className="w-4 h-4" />
                    </button>
                  </div>
                ) : (
            ...
            <div className="flex justify-center mb-8">
              <button
                ...
                className={`w-full max-w-md py-4 rounded-3xl font-title font-black text-lg tracking-wider flex items-center justify-center gap-3 transition-all shadow-lg ${
                  !pisoFile || !tipeoFile
